package by.sadykov.webblog.controllers;

import by.sadykov.webblog.models.Post;
import by.sadykov.webblog.repo.PostRepository;
...
public class BlogController {
    ...
    @GetMapping("/blog")
    public String blogMain(Model model, @RequestParam(required = false) String query) {
        Iterable<Post> posts = query != null && !query.isEmpty() ?
